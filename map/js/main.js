...
!function () {
    ...
    map.setView([48.8566,2.3522], 12.3).whenReady(handleReady);
    ...
    function handleReady() {
        ...
        d3.tsv(file, function (err, rawData) {
            ...
            // L.control.layers({
                // 'hello' : googleDark.addTo(map),
                // 'cookie' : googleDarkII
            // }, {
                // 'johnny': legend,
                // 'cherry': heatSupplier.addTo(map),
                // 'hey': heat.addTo(map),
                // 'info': markers.addTo(map)
            // }).addTo(map);
